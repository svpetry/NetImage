...
The latest tagged release is [v1.4](https://github.com/svpetry/NetImage/releases/tag/v1.4).
...
NetImage is actively evolving. The tagged `v1.4` release covers the current browsing, modification,
