...
The latest tagged release is [v1.3](https://github.com/svpetry/NetImage/releases/tag/v1.3).
...
NetImage is actively evolving. The tagged `v1.3` release covers the current browsing, modification,
